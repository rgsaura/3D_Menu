...
function getCSSMatrix(matrix2, multipliers, prepend = "") {
  ...
  for (let i = 0; i !== 16; i++) {
    matrix3d += epsilon(multipliers[i] * matrix2.elements[i]) + (i !== 15 ? "," : ")");
  }
...
function determinant2() {
  ...
  var a2 = terms[0], b2 = terms[1], c6 = terms[2], d2 = terms[3];
  return a2 * d2 - b2 * c6;
}
function determinant3() {
  ...
  var a2 = terms[0], b2 = terms[1], c6 = terms[2], d2 = terms[3], e = terms[4], f = terms[5], g = terms[6], h = terms[7], i = terms[8];
  return a2 * e * i + b2 * f * g + c6 * d2 * h - c6 * e * g - b2 * d2 * i - a2 * f * h;
}
...
function getMinor(matrix2, r, c6) {
...
function vectorEquals(a2, b2) {
  var eps = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Number.EPSILON;
  return Math.abs(a2.x - b2.x) < eps && Math.abs(a2.y - b2.y) < eps && Math.abs(a2.z - b2.z) < eps;
}
function lexicographic(a2, b2) {
  if (a2.x === b2.x) {
    if (typeof a2.z !== "undefined") {
      if (a2.y === b2.y) {
        return a2.z - b2.z;
      }
    }
...
function lerp(v0, v12, t) {
  return v0 * (1 - t) + v12 * t;
}
function inverseLerp(v0, v12, t) {
  return (t - v0) / (v12 - v0);
}
...
function rotateVectorOnVector(a2, b2) {
  var v = new Vector3().crossVectors(a2, b2);
  var c6 = a2.dot(b2);
...
function planeSegmentIntersection(plane, segment) {
  var _segment = _slicedToArray(segment, 2), a2 = _segment[0], b2 = _segment[1];
  var matrix2 = rotateVectorOnVector(plane.normal, new Vector3(0, 1, 0));
  var t = inverseLerp(a2.clone().applyMatrix3(matrix2).y, b2.clone().applyMatrix3(matrix2).y, 0);
  return new Vector3().lerpVectors(a2, b2, t);
}
...
function addValue(a2, n) {
  return [a2[0] + n, a2[1] + n];
}
function sub(a2, b2) {
  return [a2[0] - b2[0], a2[1] - b2[1]];
}
function subValue(a2, n) {
  return [a2[0] - n, a2[1] - n];
}
function scale(a2, n) {
  return [a2[0] * n, a2[1] * n];
...
function lengthSqr(a2) {
  return a2[0] * a2[0] + a2[1] * a2[1];
}
function length(a2) {
  return Math.sqrt(a2[0] * a2[0] + a2[1] * a2[1]);
}
...
function addValue2(a2, n) {
  return [a2[0] + n, a2[1] + n, a2[2] + n];
}
function sub2(a2, b2) {
  return [a2[0] - b2[0], a2[1] - b2[1], a2[2] - b2[2]];
}
function subValue2(a2, n) {
  return [a2[0] - n, a2[1] - n, a2[2] - n];
}
function scale2(a2, n) {
  return [a2[0] * n, a2[1] * n, a2[2] * n];
}
function dot2(a2, b2) {
  return a2[0] * b2[0] + a2[1] * b2[1] + a2[2] * b2[2];
}
function cross(a2, b2) {
  var x = a2[1] * b2[2] - a2[2] * b2[1];
  var y = a2[2] * b2[0] - a2[0] * b2[2];
  var z = a2[0] * b2[1] - a2[1] * b2[0];
  return [x, y, z];
}
function lengthSqr2(a2) {
  return a2[0] * a2[0] + a2[1] * a2[1] + a2[2] * a2[2];
}
function length2(a2) {
  return Math.sqrt(a2[0] * a2[0] + a2[1] * a2[1] + a2[2] * a2[2]);
}
function distance2(a2, b2) {
  return Math.sqrt((a2[0] - b2[0]) * (a2[0] - b2[0]) + (a2[1] - b2[1]) * (a2[1] - b2[1]) + (a2[2] - b2[2]) * (a2[2] - b2[2]));
}
...
function sort(myBuffer, stride, callback) {
  ...
  indices.sort(function(a2, b2) {
    var pa = myBuffer.slice(a2 * stride, a2 * stride + stride);
...
var rsqw = function rsqw2(t) {
  ...
  var a2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1;
  var f = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1 / (2 * Math.PI);
  return a2 / Math.atan(1 / delta) * Math.atan(Math.sin(2 * Math.PI * t * f) / delta);
};
...
function damp2(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  if (typeof target === "number")
    ...
    v2d.copy(target);
  a = damp(current, "x", v2d.x, smoothTime, delta, maxSpeed, easing2, eps);
  b = damp(current, "y", v2d.y, smoothTime, delta, maxSpeed, easing2, eps);
  return a || b;
}
var v3d = new Vector3();
function damp3(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  if (typeof target === "number")
    ...
    v3d.copy(target);
  a = damp(current, "x", v3d.x, smoothTime, delta, maxSpeed, easing2, eps);
  b = damp(current, "y", v3d.y, smoothTime, delta, maxSpeed, easing2, eps);
  c = damp(current, "z", v3d.z, smoothTime, delta, maxSpeed, easing2, eps);
  return a || b || c;
}
var v4d = new Vector4();
...
function dampE(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  if (Array.isArray(target))
    ...
    rot.copy(target);
  a = dampAngle(current, "x", rot.x, smoothTime, delta, maxSpeed, easing2, eps);
  b = dampAngle(current, "y", rot.y, smoothTime, delta, maxSpeed, easing2, eps);
  c = dampAngle(current, "z", rot.z, smoothTime, delta, maxSpeed, easing2, eps);
  return a || b || c;
}
var col = new Color();
function dampC(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  if (target instanceof Color)
    ...
    col.set(target);
  a = damp(current, "r", col.r, smoothTime, delta, maxSpeed, easing2, eps);
  b = damp(current, "g", col.g, smoothTime, delta, maxSpeed, easing2, eps);
  c = damp(current, "b", col.b, smoothTime, delta, maxSpeed, easing2, eps);
  return a || b || c;
}
...
function dampQ(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  ...
  qt.z *= multi;
  qt.w *= multi;
  a = damp(current, "x", qt.x, smoothTime, delta, maxSpeed, easing2, eps);
  b = damp(current, "y", qt.y, smoothTime, delta, maxSpeed, easing2, eps);
  c = damp(current, "z", qt.z, smoothTime, delta, maxSpeed, easing2, eps);
  d = damp(current, "w", qt.w, smoothTime, delta, maxSpeed, easing2, eps);
...
function dampS(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  ...
  a = damp(current, "radius", spherical.radius, smoothTime, delta, maxSpeed, easing2, eps);
  b = dampAngle(current, "phi", spherical.phi, smoothTime, delta, maxSpeed, easing2, eps);
  c = dampAngle(current, "theta", spherical.theta, smoothTime, delta, maxSpeed, easing2, eps);
  return a || b || c;
}
var mat = new Matrix4();
...
function dampM(current, target, smoothTime, delta, maxSpeed, easing2, eps) {
  ...
  a = damp3(cur.__damp.position, mPos, smoothTime, delta, maxSpeed, easing2, eps);
  b = dampQ(cur.__damp.rotation, mRot, smoothTime, delta, maxSpeed, easing2, eps);
  c = damp3(cur.__damp.scale, mSca, smoothTime, delta, maxSpeed, easing2, eps);
...
function _possibleConstructorReturn(self, call3) {
...
function ScrollControls({
  ...
  }, [pages, distance3, horizontal, el, fill, fixed, target]);
  React5.useEffect(() => {
...
function useSprings(length3, props, deps) {
  ...
  const context6 = (0, import_react3.useContext)(SpringContext);
  const prevContext = usePrev(context6);
  const hasContext = context6 !== prevContext && hasProps(context6);
  useIsomorphicLayoutEffect(() => {
    layoutId.current++;
...
function PresentationControls({
  ...
  const rPolar = React9.useMemo(() => [rotation[0] + polar[0], rotation[0] + polar[1]], [rotation[0], polar[0], polar[1]]);
  const rAzimuth = React9.useMemo(() => [rotation[1] + azimuth[0], rotation[1] + azimuth[1]], [rotation[1], azimuth[0], azimuth[1]]);
  const rInitial = React9.useMemo(() => [MathUtils.clamp(rotation[0], ...rPolar), MathUtils.clamp(rotation[1], ...rAzimuth), rotation[2]], [rotation[0], rotation[1], rotation[2], rPolar, rAzimuth]);
...
function Select({
  ...
  const onClick = React11.useCallback((e) => {
    e.stopPropagation();
    dispatch({
  ...
  const onPointerMissed = React11.useCallback((e) => !hovered && dispatch({}), [hovered]);
...
var View = ({
  ...
  const [virtualScene] = React12.useState(() => new Scene());
  const compute = React12.useCallback((event, state) => {
  ...
  const [ready, toggle] = React12.useReducer(() => true, false);
  React12.useEffect(() => {
    var _track$current2;
    rect.current = (_track$current2 = track.current) == null ? void 0 : _track$current2.getBoundingClientRect();
    toggle();
  }, []);
  return React12.createElement(React12.Fragment, null, ready && createPortal(React12.createElement(Container, {
    canvasSize: size,
    frames,
    scene,
    track,
...
var context5 = React13.createContext(null);
...
var AxisArrow = ({
  ...
  const {
    ...
    onDragEnd,
    userData
  } = React14.useContext(context5);
  const camControls = useThree((state) => state.controls);
  const divRef = React14.useRef(null);
  const objRef = React14.useRef(null);
  const clickInfo = React14.useRef(null);
  const offset0 = React14.useRef(0);
  const [isHovered, setIsHovered] = React14.useState(false);
  const onPointerDown = React14.useCallback((e) => {
    if (annotations) {
  ...
  const onPointerMove = React14.useCallback((e) => {
    e.stopPropagation();
    if (!isHovered)
      setIsHovered(true);
  ...
  const onPointerUp = React14.useCallback((e) => {
    if (annotations) {
  ...
  const onPointerOut = React14.useCallback((e) => {
    e.stopPropagation();
    setIsHovered(false);
  }, []);
  const {
  ...
  }, [direction, scale3, lineWidth, fixed]);
  const color_ = isHovered ? hoveredColor : axisColors[axis];
  return React14.createElement("group", {
    ref: objRef
  }, React14.createElement("group", {
    matrix: matrixL,
    ...
    onPointerUp,
    onPointerOut
  }, annotations && React14.createElement(Html, {
    ...
    position: [0, cylinderLength + coneLength / 2, 0],
    renderOrder: 500
  }, React14.createElement("coneGeometry", {
    args: [coneWidth, coneLength, 24, 1]
  }), React14.createElement("meshBasicMaterial", {
    transparent: true,
    depthTest,
    color: color_,
    opacity,
...
var decomposeIntoBasis = (e1, e2, offset) => {
  ...
  const c22 = offset.getComponent(i2);
...
var PlaneSlider = ({
  ...
  const {
    ...
    onDragEnd,
    userData
  } = React15.useContext(context5);
  const camControls = useThree((state) => state.controls);
  const divRef = React15.useRef(null);
  const objRef = React15.useRef(null);
  const clickInfo = React15.useRef(null);
  const offsetX0 = React15.useRef(0);
  const offsetY0 = React15.useRef(0);
  const [isHovered, setIsHovered] = React15.useState(false);
  const onPointerDown = React15.useCallback((e) => {
    if (annotations) {
  ...
  const onPointerMove = React15.useCallback((e) => {
    e.stopPropagation();
    if (!isHovered)
      setIsHovered(true);
    if (clickInfo.current) {
  ...
  const onPointerUp = React15.useCallback((e) => {
    if (annotations) {
      divRef.current.style.display = "none";
    }
    e.stopPropagation();
  ...
  const onPointerOut = React15.useCallback((e) => {
    e.stopPropagation();
    setIsHovered(false);
  }, []);
  const matrixL = React15.useMemo(() => {
    const dir1N = dir1.clone().normalize();
    const dir2N = dir2.clone().normalize();
    return new Matrix4().makeBasis(dir1N, dir2N, dir1N.clone().cross(dir2N));
  }, [dir1, dir2]);
  const pos1 = fixed ? 1 / 7 : scale3 / 7;
  const length3 = fixed ? 0.225 : scale3 * 0.225;
  const color = isHovered ? hoveredColor : axisColors[axis];
  const points = React15.useMemo(() => [new Vector3(0, 0, 0), new Vector3(0, length3, 0), new Vector3(length3, length3, 0), new Vector3(length3, 0, 0), new Vector3(0, 0, 0)], [length3]);
  return React15.createElement("group", {
    ref: objRef,
    matrix: matrixL,
    matrixAutoUpdate: false
  }, annotations && React15.createElement(Html, {
    position: [0, 0, 0]
    ...
    className: annotationsClass,
    ref: divRef
  })), React15.createElement("group", {
    position: [pos1 * 1.7, pos1 * 1.7, 0]
  }, React15.createElement("mesh", {
    visible: true,
    onPointerDown,
    onPointerMove,
    onPointerUp,
    ...
    scale: length3,
    userData
  }, React15.createElement("planeGeometry", null), React15.createElement("meshBasicMaterial", {
    transparent: true,
    depthTest,
    color,
    polygonOffset: true,
...
var AxisRotator = ({
  ...
  const {
    ...
    onDragEnd,
    userData
  } = React16.useContext(context5);
  const camControls = useThree((state) => state.controls);
  const divRef = React16.useRef(null);
  const objRef = React16.useRef(null);
  const angle0 = React16.useRef(0);
  const angle = React16.useRef(0);
  const clickInfo = React16.useRef(null);
  const [isHovered, setIsHovered] = React16.useState(false);
  const onPointerDown = React16.useCallback((e) => {
    if (annotations) {
  ...
  const onPointerMove = React16.useCallback((e) => {
    e.stopPropagation();
    if (!isHovered)
      setIsHovered(true);
    if (clickInfo.current) {
      ...
      ray2.intersectPlane(plane, intersection2);
      let deltaAngle2 = calculateAngle(clickPoint, intersection2, origin, e1, e2);
      ...
      if (min !== void 0 && max !== void 0 && max - min < 2 * Math.PI) {
        ...
        deltaAngle2 = (0, import_lodash.default)(deltaAngle2, min - angle0.current, max - angle0.current);
  ...
  const onPointerUp = React16.useCallback((e) => {
    if (annotations) {
      divRef.current.style.display = "none";
    }
    e.stopPropagation();
  ...
  const onPointerOut = React16.useCallback((e) => {
    e.stopPropagation();
    setIsHovered(false);
  }, []);
  const matrixL = React16.useMemo(() => {
    const dir1N = dir1.clone().normalize();
    const dir2N = dir2.clone().normalize();
    return new Matrix4().makeBasis(dir1N, dir2N, dir1N.clone().cross(dir2N));
  }, [dir1, dir2]);
  const r = fixed ? 0.65 : scale3 * 0.65;
  const arc = React16.useMemo(() => {
    const segments = 32;
    const points = [];
  ...
  return React16.createElement("group", {
    ref: objRef,
    onPointerDown,
    onPointerMove,
    onPointerUp,
    ...
    matrix: matrixL,
    matrixAutoUpdate: false
  }, annotations && React16.createElement(Html, {
    position: [r, r, 0]
...
var PivotControls = React17.forwardRef(({
  matrix: matrix2,
  onDragStart,
  onDrag,
  onDragEnd,
  ...
  const gizmoRef = React17.useRef(null);
  const childrenRef = React17.useRef(null);
  const translation = React17.useRef([0, 0, 0]);
  ...
  const config2 = React17.useMemo(() => ({
    ...
    annotations,
    annotationsClass
  }), [onDragStart, onDrag, onDragEnd, translation, translationLimits, rotationLimits, depthTest, scale3, lineWidth, fixed, ...axisColors, hoveredColor, opacity, userData, autoTransform, annotations, annotationsClass]);
  ...
  return React17.createElement(context5.Provider, {
    value: config2
  }, React17.createElement("group", {
    ref: parentRef
  }, React17.createElement("group", _extends({
    ref,
    matrix: matrix2,
    matrixAutoUpdate: false
  }, props), React17.createElement("group", {
    visible,
    ref: gizmoRef,
    position: offset,
    rotation
  }, !disableAxes && activeAxes[0] && React17.createElement(AxisArrow, {
    axis: 0,
    direction: xDir
  }), !disableAxes && activeAxes[1] && React17.createElement(AxisArrow, {
    axis: 1,
    direction: yDir
  }), !disableAxes && activeAxes[2] && React17.createElement(AxisArrow, {
    axis: 2,
    direction: zDir
  }), !disableSliders && activeAxes[0] && activeAxes[1] && React17.createElement(PlaneSlider, {
    axis: 2,
    dir1: xDir,
    dir2: yDir
  }), !disableSliders && activeAxes[0] && activeAxes[2] && React17.createElement(PlaneSlider, {
    axis: 1,
    dir1: zDir,
    dir2: xDir
  }), !disableSliders && activeAxes[2] && activeAxes[1] && React17.createElement(PlaneSlider, {
    axis: 0,
    dir1: yDir,
    dir2: zDir
  }), !disableRotations && activeAxes[0] && activeAxes[1] && React17.createElement(AxisRotator, {
    axis: 2,
    dir1: xDir,
    dir2: yDir
  }), !disableRotations && activeAxes[0] && activeAxes[2] && React17.createElement(AxisRotator, {
    axis: 1,
    dir1: zDir,
    dir2: xDir
  }), !disableRotations && activeAxes[2] && activeAxes[1] && React17.createElement(AxisRotator, {
    axis: 0,
    dir1: yDir,
    dir2: zDir
  })), React17.createElement("group", {
